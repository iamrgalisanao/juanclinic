                    ...
                    <div className="space-y-4">
                        <div className="relative">
                            <input
                                ...
                                className="w-full bg-slate-50 border border-his-slate-100 rounded-xl pl-10 pr-4 py-3 text-[11px] font-bold text-slate-700 focus:ring-2 focus:ring-his-green-500/20 focus:border-his-green-400 outline-none transition-all"
                            />
                        ...
                        <div className="flex bg-slate-50 p-1 rounded-xl border border-his-slate-100">
                            <button
                                ...
                                className={`flex-1 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all ${threadTypeFilter === 'ALL' ? 'bg-white text-his-green-500 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                            >
                                All
                            </button>
                            <button
                                ...
                                className={`flex-1 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all ${threadTypeFilter === 'DIRECT' ? 'bg-white text-his-green-500 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                            >
                                Direct
                            </button>
                            <button
                                ...
                                className={`flex-1 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all ${threadTypeFilter === 'GROUP' ? 'bg-white text-his-green-500 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                            >
                                Groups
                            </button>
                        </div>
