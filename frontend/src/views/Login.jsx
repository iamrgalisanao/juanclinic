...
const Login = ({ onLoginSuccess }) => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-6 relative overflow-hidden bg-slate-900">
            ...
            {/* Content Container */}
            <div className="relative z-10 w-full max-w-lg animate-in fade-in slide-in-from-bottom-10 duration-1000">
                <div className="mb-12 text-center">
                    <div className="w-20 h-20 bg-his-green-500 rounded-3xl flex items-center justify-center text-white mx-auto mb-6 shadow-2xl shadow-his-green-500/20">
                    ...
                    <h1 className="text-5xl font-black text-white tracking-tighter uppercase italic">JUAN CLINIC</h1>
                    <p className="text-his-green-500 font-bold text-sm tracking-[0.4em] mt-3 uppercase">Health Information System</p>
                </div>

                <div className="bg-white/10 backdrop-blur-3xl rounded-[3rem] p-12 border border-white/10 shadow-[0_32px_128px_-16px_rgba(0,0,0,0.5)]">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className={`w-full px-8 py-5 bg-white/5 border ${errors.email ? 'border-rose-500' : 'border-white/10'} rounded-2xl text-white font-bold focus:bg-white/10 focus:border-his-green-500 transition-all outline-none placeholder:text-slate-600`}
                        ...
                        <div className="space-y-2 relative">
                            ...
                            <input
                                ...
                                className={`w-full px-8 py-5 bg-white/5 border ${errors.password ? 'border-rose-500' : 'border-white/10'} rounded-2xl text-white font-bold focus:bg-white/10 focus:border-his-green-500 transition-all outline-none placeholder:text-slate-600`}
                                placeholder="••••••••"
                            />
                            <div className="absolute right-6 top-11 text-slate-500">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-6 bg-his-green-500 text-white text-xs font-black rounded-3xl hover:bg-his-green-400 hover:scale-[1.02] active:scale-[0.98] transition-all uppercase tracking-[0.3em] shadow-2xl shadow-his-green-500/20 group relative overflow-hidden"
                        >
                ...
                <div className="mt-12 text-center text-[10px] font-black text-slate-600 uppercase tracking-[0.3em] space-y-2">
